...
const quizTypes = ["Topic-based", "Unit Review", "Diagnostic", "Practice"];
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <Button variant="outline" onClick={() => { setSubmitted(false); setTitle(""); setSubject(""); setTopic(""); setQuizType(""); setDuration(""); setQuestions([emptyQuestion()]); }}>
            Create Another
          </Button>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <select
                  value={quizType}
                  onChange={(e) => { setQuizType(e.target.value); if (errors.type) setErrors((p) => ({ ...p, type: undefined })); }}
