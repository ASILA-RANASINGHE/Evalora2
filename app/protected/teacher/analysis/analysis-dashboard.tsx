...
import type { TeacherAnalyticsPayload } from "@/lib/actions/analytics";

export function AnalysisDashboard({ payload }: { payload: TeacherAnalyticsPayload }) {
  const { students, analytics } = payload;
  ...
  return (
    <div className="space-y-6">
      {/* Overview stat cards */}
      <OverviewCards stats={analytics.overviewStats} />
      ...
      <Tabs defaultValue="students">
        ...
        <TabsContent value="analytics" className="space-y-6 mt-0">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <ClassDistribution data={analytics.scoreDistribution} />
            <SubjectComparison data={analytics.subjectPerformance} />
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="lg:col-span-2">
              <TopicDifficulty topics={analytics.topicDifficulty} students={students} />
            </div>
            <StudyTimePanel stats={analytics.studyTimeStats} />
          </div>
        </TabsContent>
      </Tabs>
    </div>
