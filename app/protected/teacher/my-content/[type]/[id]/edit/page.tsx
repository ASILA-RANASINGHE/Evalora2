...
import { QuizEditForm } from "./quiz-edit";
import { PaperEditForm } from "./paper-edit";
...
export default function EditContentPage() {
  ...
  const backHref = `/protected/teacher/my-content/${type}/${id}`;
  ...
  // Quiz / paper state (typed as any for simplicity; form components handle typing)
    ...
    const load = async () => {
      try {
        if (type === "notes") {
          ...
          if (!data) { router.push("/protected/teacher/my-content"); return; }
          setTitle(data.title);
          setTopic(data.topic || "");
          setGrade(data.grade || "");
          ...
          router.push("/protected/teacher/my-content");
          return;
        }
      } finally {
        setLoading(false);
