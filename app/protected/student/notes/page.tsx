    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#4D2FB2] via-[#696FC7] to-[#B7BDF7] p-6 text-white shadow-lg">
        ...
        <div className="relative">
          ...
          <p className="text-[#B7BDF7] mt-1 text-sm font-medium">Select a subject to browse notes</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {workingSubjects.map((subject) => (
            <Link href={`/protected/student/notes/subject/${subject.name.toLowerCase().replace(/ /g, "-")}`} key={subject.name}>
